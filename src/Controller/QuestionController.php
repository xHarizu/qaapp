...
class QuestionController extends AbstractController
{
     ...
     *
     */
    public function show(int $id, AnswerRepository $answerRepository): Response
    {
        $questions = $this->questionRepository->findOneById($id);

        return $this->render(
            'question/show.html.twig',
            ['questions' => $questions, 'answers' => $answerRepository->findAll()]
        );
    }
     ...
     * )
     */
    public function delete(Request $request, Question $question, QuestionRepository $questionRepository, Answer $answer, AnswerRepository $answerRepository): Response
    {
